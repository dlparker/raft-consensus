...
def set_levels(handler_names):
    ...
    log_loggers['raft.states.state_map'] = debug_log
    log_loggers['raft.states.base_state'] = debug_log
    ...
    #log_loggers['raft.dev_tools.memory_log'] = debug_log
    ...
    #log_loggers['raft.dev_tools.memory_comms'] = debug_log
    return log_loggers
